...
#include "vendor_kms_reader_writer_private.h"
#include "vendor_kms_kmip_item_type_private.h"
#include "vendor_kms_kmip_tag_type_private.h"
#include "vendor_kms_endian_private.h"
#include "vendor_kms_request_str.h"
...
#define KMS_ASSERT(x) if (!(x)) { fprintf (stderr, "error on statement: %s\n", #x); abort(); }
