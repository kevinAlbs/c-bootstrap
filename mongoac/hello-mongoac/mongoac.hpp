...
public:
  ...
  Bson &operator=(Bson &&o) noexcept { std::swap(p_, o.p_); return *this; }
...
public:
  ...
  Error &operator=(Error &&o) noexcept { std::swap(p_, o.p_); return *this; }
...
public:
  ...
  Future &operator=(Future &&o) noexcept { std::swap(p_, o.p_); return *this; }

  bool poll() const { return mongoac_future_poll(p_); }
  void getVoid(Error &e) const { mongoac_future_get_void(p_, e.raw()); }
  int32_t getInt32(Error &e) const { return mongoac_future_get_int32(p_, e.raw()); }
  Bson getBson(Error &e) const { return Bson(mongoac_future_get_bson(p_, e.raw())); }
private:
  mongoac_future_t *p_;
};
...
public:
  ...
  Collection &operator=(Collection &&o) noexcept { std::swap(p_, o.p_); return *this; }
  ...
  Future countDocuments(const bson_t *filter, Error &e) const {
    return Future(mongoac_collection_count_documents_async(p_, filter, e.raw()));
  }
...
public:
  ...
  Database &operator=(Database &&o) noexcept { std::swap(p_, o.p_); return *this; }
...
public:
  ...
  Client &operator=(Client &&o) noexcept { std::swap(p_, o.p_); return *this; }
